...
class BlocosAdapter(
    ...
    inner class BlocoViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val textoCompleto: TextView = itemView.findViewById(R.id.bloco_texto_completo)
        ...
        fun bind(bloco: Bloco) {
            ...
            // --- LÓGICA DO ÍCONE CORRIGIDA DE ACORDO COM SEU PEDIDO ---
            // Agora, a estrela com borda (outline) significa que está favoritado.
            val favoriteIconRes = if (bloco.favorito) R.drawable.ic_star_outline else R.drawable.ic_star_filled
